      ...
      <div className="admin-login-overlay">
        <div className="login-card glass">
          <div className="lock-header">
            ...
            <p className="hint">Usa las credenciales configuradas en Vercel/servidor (ADMIN_USER / ADMIN_PASS). Alternativamente, puedes usar NEXT_PUBLIC_ADMIN_USER / NEXT_PUBLIC_ADMIN_PASS.</p>
          </div>
